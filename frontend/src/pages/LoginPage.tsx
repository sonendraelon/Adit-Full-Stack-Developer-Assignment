    ...
    <div className="max-w-md mx-auto mt-16 glass-panel p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full bg-gradient-to-r from-primary to-blue-500 text-primary-foreground p-3.5 rounded-xl font-bold hover:shadow-lg hover:opacity-90 transition-all flex justify-center items-center gap-2"
        >
